    ...
    <div style={{ minHeight: "100vh", background: "#0A0A1A", color: "white", fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <header style={{
        ...
        <nav style={{ display: "flex", gap: "4px", alignItems: "center" }}>
          ...
          <a href="/ventas" style={{ padding: "8px 14px", background: "none", border: "none", color: "#B0B0D0", cursor: "pointer", fontSize: "13px", fontWeight: "500", textDecoration: "none", borderRadius: "6px", transition: "all 0.2s" }}>Ventas</a>
